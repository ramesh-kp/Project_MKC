...
device_id = "mkcwirasdevice1"  # Add device id
iot_hub_name = "mkc-iot-hub"  # Add iot hub name
# Add sas token string
sas_token = "HostName=mkc-iot-hub.azure-devices.net;SharedAccessKeyName=mkc-iot-hub-test;SharedAccessKey=20e/3aZo4xR4XxX34yKLdwVb+YlYqE9lYFABdLcKVl4="
