...
if __name__ == "__main__":
    ...
    result.update(CODSensor(100).enable_reading())
    result.update(PhSensor(110).enable_reading())
    result.update(BODSensor(100).enable_reading())
    result.update(ConductivitySensor(120).enable_reading())
    result.update(EnergymeterSensor(170).enable_reading())
    result.update(TDSSensor(120).enable_reading())
    result.update(TemperatureSensor(100).enable_reading())
    result.update(TSSSensor(100).enable_reading())
    print(result)
...
# result = BODSensor(101).set_bod_configurations({'BOD': [101, 9729, 10]})
# print(result)
