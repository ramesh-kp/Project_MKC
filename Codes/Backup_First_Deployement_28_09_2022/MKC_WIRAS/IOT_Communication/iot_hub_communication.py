...
class Iotconnection(object):
    ...
    @classmethod
    def iothub_client_send_message(cls, iothub_client, reading):
        """
    ...
    def send_sensor_readings(self, client_obj):
        """
        Description: Open the first file generated,once the sensor readings are send to
        azure the file is truncated.
