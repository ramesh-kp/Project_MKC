...
class Device_Reading():
    ...
    def Get_Sensor_Reading(self, sensor):
        '''
        Description:        First check whether the given sensor configurations are in the Sensor_Configuration_File,if true then connect with
                            the gateway client and check the output from the sensors.
