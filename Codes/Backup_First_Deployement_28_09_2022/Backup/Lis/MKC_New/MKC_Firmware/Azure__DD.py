...
#     # def Set_Data(self, dv):
#     #     print('data reached azure : ', dv)
#     #     global dataB
#     #     dataB = dv
#     #     print('data reached azure global : ', dataB)
...
#             datetime_ist = datetime.now(IST).strftime(
#                 '%Y:%m:%d %H:%M:%S %Z %z')
#             result.append(datetime_ist)
...
#                         result.append(original_energymeter_reading)
#                     else:
#                         result.append(energymeter_reading[i])
#             except Exception as e:
...
#                         result.append(cod_send_data)
#                     else:
#                         result.append(cod_reading[i])
#             except Exception as e:
#                 return Ethernet_Network_Error["Error_Message"]
...
#                         result.append(bod_send_data)
#                     else:
#                         result.append(bod_reading[i])
#             except Exception as e:
#                 return Ethernet_Network_Error["Error_Message"]
...
#                         result.append(tss_send_data)
#                     else:
#                         result.append(tss_reading[i])
#             except Exception as e:
#                 return Ethernet_Network_Error["Error_Message"]
...
#                         result.append(temperature_send_data)
#                     else:
#                         result.append(temperature_reading[i])
#             except Exception as e:
#                 return Ethernet_Network_Error["Error_Message"]
...
#                         result.append(ph_send_data)
#                     else:
#                         result.append(ph_reading[i])
#             except Exception as e:
#                 return Ethernet_Network_Error["Error_Message"]
...
#                         result.append(tds_send_data)
#                     else:
#                         result.append(tds_reading[i])
#             except Exception as e:
#                 return Ethernet_Network_Error["Error_Message"]
...
#                         result.append(conductivity_send_data)
#                     else:
#                         result.append(conductivity_reading[i])
#             except Exception as e:
#                 return Ethernet_Network_Error["Error_Message"]
...
#     @staticmethod
#     def getInstance():
#         if Receive_Azure_Data.__instance == None:
#             Receive_Azure_Data()
#         return Receive_Azure_Data.__instance
...
#             raise Exception("This class is a singleton!")
#         else:
#             Receive_Azure_Data.__instance = self

#     def on_event_batch(self, partition_context, events):
#         global receive_data
#         for event in events:
#             # Receive_Azure_Data.getInstance().Azure_Read(event.body_as_str())
#             data = Receive_Azure_Data.getInstance().Azure_Read(event.body_as_str())
#             # print("%%%%%%", receive_data)
#             return receive_data.append(data)
#         print("ggggggg", receive_data)
...
#         try:
#             with self.client:
#                 data_received = self.client.receive_batch(
#                     on_event_batch=Receive_Azure_Data.getInstance().on_event_batch, on_error=Receive_Azure_Data.getInstance().on_error)
#                 # print("&&&&&&&&", data_received)
...
#                     # Send_Sensor_Datas.getInstance().Iothub_Client_Telemetry_Sample_Run(receive_data)
#                     return receive_data
#             else:
...
#         Output Type:        None
#         '''
#         azure_data = str(Receive_Azure_Data.getInstance().Azure_Read())
#         print(azure_data)
#         # Receive_Azure_Data().getInstance().Setting_Frequency_Time(azure_data)
#         # Receive_Azure_Data().getInstance().Adding_Sensor_Configuration(azure_data)
#         # Receive_Azure_Data().getInstance().Clear_Configuration(azure_data)


# azure_data = Receive_Azure_Data().getInstance().receive_batch()

# # azure_data = str(Receive_Azure_Data().Azure_Read())
# # print("AAAAAAA", azure_data)
# # Receive_Azure_Data().getInstance().Setting_Frequency_Time(azure_data)
# # Receive_Azure_Data.getInstance().Adding_Sensor_Configuration(azure_data)
# # Receive_Azure_Data().Clear_Configuration(azure_data)
# Receive_Azure_Data().getInstance().receive_batch()
