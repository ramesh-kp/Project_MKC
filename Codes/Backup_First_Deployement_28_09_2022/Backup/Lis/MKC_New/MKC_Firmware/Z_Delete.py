...
# # Iot_Connection_String = "Endpoint=sb://iothub-ns-mkc-iot-hu-17383143-0e321ed71e.servicebus.windows.net/;SharedAccessKeyName=iothubowner;SharedAccessKey=CoamC5VpewflsRafv4XBI9nEkxCBJ1FJZXnBC4GUwvA=;EntityPath=mkc-iot-hub"
# # from Main_Application import iothub_client
# result = []
...
#     #     # check = self.iothub_client
#     #     print("kkkkkkkkkk", self.iothub_client)
#     #     print(self.iothub_client)
#     #     if self.__instance != None:
#     #         raise Exception("This class is a singleton!")
#     #     else:
#     #         Send_Sensor_Datas.__instance = self
#     def Iothub_Client_Init(self, iothub_client):
#         '''
...
#     # @staticmethod
#     def Iothub_Client_Telemetry_Sample_Run(self, data, reading):
#         '''
...
#             # iothub_client = Send_Sensor_Datas().Iothub_Client_Init()
#             message = Message(str(reading))
#             # print("llllllllllllll", self.iothub_client)
...
#                             cod_reading[i], 2, 3)
#                         cod_config = Send_Sensor_Datas.Get_Sensor_Configurations(
#                             "COD")
#                         cod_send_data = {
...
#                             bod_reading[i], 4, 5)
#                         bod_config = Send_Sensor_Datas.Get_Sensor_Configurations(
#                             "COD")
#                         bod_send_data = {
...
#                             tss_reading[i], 0, 1)
#                         tss_config = Send_Sensor_Datas.Get_Sensor_Configurations(
#                             "TSS")
#                         tss_send_data = {
...
#                         temperature_config = Send_Sensor_Datas().Get_Sensor_Configurations("Temperature")
...
#                             ph_reading[i], 2, 3)
#                         ph_config = Send_Sensor_Datas.Get_Sensor_Configurations(
#                             "Ph")
#                         ph_send_data = {
...
#                             tds_reading[i], 2, 3)
#                         tds_config = Send_Sensor_Datas.Get_Sensor_Configurations(
#                             "TDS")
#                         tds_send_data = {
...
#             result = []
#             Send_Sensor_Datas.Iothub_Client_Telemetry_Sample_Run(final_data)
...
#                 json.dump([], file)
#                 print("Helloiiiiiiiiiiiiiiiiiiiiiiiiiii")

#             print("Recievrd_Input##############################", azure_input)
...
#                 print("ghghghghghghghg", iotclient)
#                 Message_Length = int(
...
#                         # obj.Iothub_Client_Telemetry_Sample_Run(
#                         #     iotclient, receive_data)
#                         print("hgjhjghfghhfgdshd")
#                         return receive_data
#                 else:
...
#         azure_data = str(Receive_Azure_Data().Azure_Read(data))
