...
#     data = ast.literal_eval(input("Input from Azure:"))
#     if "COD" in data:
#         new_configuration = data["COD"]
#         with open("Sensor_Readings/z_cod_reading.py", 'r+') as pythonfile:
#             file_data = pythonfile.read()
#             print(file_data)
#             # if data == dat:
#             #     open file cod_reading.py
#             #     check the data already in thhe list
#             #     if not append the cod config
#             #     write the new cod configuration to cod_reading.py
#             #     check the file
