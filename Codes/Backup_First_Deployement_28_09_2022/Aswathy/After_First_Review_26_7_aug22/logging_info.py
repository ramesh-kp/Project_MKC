...
import logging
import os
from general_configurations import BASE_DIR, Folder_name, No_of_log_files, file_size, write_mode, Log_levels
...
class Datalogs(object):
    ...
    def logging_error(self, data, filename, loglevel):
        ...
        if loglevel == logging.DEBUG:
            logging_error.debug(data + " - " + str(Log_levels["Debug"]))
        elif loglevel == logging.INFO:
            logging_error.info(data + " - " + str(Log_levels["Info"]))
