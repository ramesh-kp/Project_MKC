...
class EnergymeterSensor(object):
    ...
    def parse_rawdata_energymeter(cls, energymeter_reading_raw, position):
        ...
        try:
            ...
            energymeter_final_data = {slave_id : energy_meter_data}
        ...
        try:
            ...
            for pos in range(len(self.energymeter_configurations)):
                ...
                while True:
                    ...
                    # print("energymeter_reading",energymeter_reading)
...
#     # @classmethod
#     def parse_rawdata_energymeter(self, energymeter_reading_raw, pos):
#         try:
#             slave_id = energymeter_reading_raw[1]
#             ckwh = energymeter_reading_raw[5] / 1000
#             ckah = energymeter_reading_raw[7] / 1000
...
#                         ValidationError[MKC17], "Energymeter_Error.log")
#                 else:
#                     sensor_result.update({"None": None})
#             elif sensor_reading_check == ErrorMessages[ModbusSlaveIdErrorMessage]:
#                 sensor_result.update({ErrorMessages[ErrorMessageSensor].format(
...
#                 Datalogs().logging_error(
#                     ValidationError[MKC21], "Energymeter_Error.log")
#             else:
