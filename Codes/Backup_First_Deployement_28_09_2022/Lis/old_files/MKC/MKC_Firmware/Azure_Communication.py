...
class Send_Sensor_Datas:
    ...
    def Iothub_Client_Telemetry_Sample_Run(self, reading):
        ...
        try:
            ...
            return Network_Connection_Error["Error_Message"]
...
class Receive_Azure_Data:
    ...
    def Configuration_Add_Sensor_Details(self, data, sensor):
        ...
        if length_key == 3:
            ...
            Data_Logs().Error_log(Validation_Error["MKC7"])
    ...
    def Azure_Read(self):
        ...
        try:
            ...
            Message_Content_length = len(azure_input[26 + Variable_Length:])

            if Total_Length == (Variable_Length + Message_Length + 16):
                if Message_Length == Message_Content_length:
