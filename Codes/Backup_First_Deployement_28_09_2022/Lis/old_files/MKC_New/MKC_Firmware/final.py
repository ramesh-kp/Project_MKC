...
class Send_Sensor_Datas:
    ...
    def read_frequency(self):
        '''
        Description:        Read the Frequency_Time in Sensor_Configuration_File.
...
class Receive_Azure_Data:
    ...
    def set_frequency_time(self, data):
        '''
    ...
    def set_sensor_configuration(self, data):
        '''
    ...
    def azure_data_config(client_obj):
        ...
        Receive_Azure_Data().set_frequency_time(azure_data)
        Receive_Azure_Data().set_sensor_configuration(azure_data)
